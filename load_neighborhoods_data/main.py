...
SOURCE_SQL_PATH = DIR_NAME / 'sql' / 'source_phl_neighborhoods.sql'
CORE_SQL_PATH = DIR_NAME / 'sql' / 'core_phl_neighborhoods.sql'

def ensure_datasets(client):
    """Create both source and core datasets if they don't exist"""
...
def run_sql_neighborhoods(request):
...
if __name__ == '__main__':
    ...
    app = create_app(target=run_sql_neighborhoods)
