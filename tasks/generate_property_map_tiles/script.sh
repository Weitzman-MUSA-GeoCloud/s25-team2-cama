...
# Download the property-tile-info.geojson file from the temp bucket.
gcloud storage cp gs://musa5090s25-team2-temp_data/property-tile-info.geojson ./property-tile-info.geojson
...
ogr2ogr \
  ...
  -dsco COMPRESS=NO \
  ./properties \
  ./property-tile-info.geojson

# Upload the vector tileset to the public bucket.
gcloud storage cp \
  --recursive \
  ./properties \
  gs://musa5090s25-team2-public/tiles
