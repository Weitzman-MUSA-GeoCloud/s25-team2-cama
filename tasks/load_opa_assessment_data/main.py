...
SOURCE_SQL_PATH = DIR_NAME / 'sql' / 'source_opa_assessment.sql'
CORE_SQL_PATH = DIR_NAME / 'sql' / 'core_opa_assessment.sql'
...
def run_sql_opa_assessment(request):
...
if __name__ == '__main__':
    ...
    app = create_app(target=run_sql_opa_assessment)
