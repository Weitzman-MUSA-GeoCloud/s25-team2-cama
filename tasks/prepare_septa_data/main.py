...
BUCKET_NAME_RAW = os.getenv("RAW_DATA_BUCKET")
BUCKET_NAME_PREPARED = os.getenv("PREPARED_DATA_BUCKET")

RAW_BLOBNAME = "phl_septa/merged_septa.geojson"
PREPARED_BLOBNAME = "tables/phl_septa/phl_septa.jsonl"

@functions_framework.http
def prepare_phl_septa(request):
    """Processes SEPTA station data and converts it to JSONL format."""
    print("Preparing Philadelphia SEPTA data...")

    storage_client = storage.Client()

    # Download raw data from Cloud Storage
    raw_filename = DIRNAME / "phl_septa.geojson"
    prepared_filename = DIRNAME / "phl_septa.jsonl"
