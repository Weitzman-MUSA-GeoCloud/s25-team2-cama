...
SOURCE_SQL_PATH = DIR_NAME / 'sql' / 'source_pwd_parcels.sql'
CORE_SQL_PATH = DIR_NAME / 'sql' / 'core_pwd_parcels.sql'
...
def run_sql_pwd_parcels(request):
...
if __name__ == '__main__':
    ...
    app = create_app(target=run_sql_pwd_parcels)
